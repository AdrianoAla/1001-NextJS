    ...
    return (
        <>
            ...
            <div className={styles.container}>
                ...
                <h4 id={styles.thanks}>
                    I want to thank everyone who helped me with the creation of this project. But especially Wam, Kabs, Prince, Khalen, Max, and everyone else in the 1001 discord server.
                </h4>
            </div>
            <div className={styles.container}>
